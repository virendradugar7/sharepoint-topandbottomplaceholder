...
export class operations {
    ...
    public nav_items(context: WebPartContext): Promise<any> {
        let restApiUrl: string = context.pageContext.web.absoluteUrl + "/_api/web/navigation/QuickLaunch?$expand=children";
        var optionslist: any = [];
    ...
    public CreateListItem(context: WebPartContext, listoption: string): Promise<string> {
        ...
        //const body: string = JSON.stringify({ Title: "New Tile Created",money:"100",createddate:new Date().toISOString(),check:false,description:"cant write that much",choice:'choice 2',TO:'choice1'});
        const body: string = JSON.stringify({ Title: "Student",manage:{__metadat:{"type":"SP.Taxonomy.TaxanomyFieldValue"},TermGuid:'<71c016e8-0901-45ce-9003-507f7f7c7698>'}});
